...
# CRITICAL: Reset settings cache if DATABASE_PATH is set via environment variable
# This ensures test environments use the correct database path
...
async def lifespan(app: FastAPI) -> AsyncGenerator:
    ...
    app_logger = get_app_logger("lifecycle")
    ...
    try:
        ...
        app_logger.log_error("startup_failure", str(e), exc_info=True)
