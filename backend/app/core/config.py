...
class DatabaseSettings(BaseSettings):
    ...
    def url(self) -> str:
        ...
        # Convert Windows backslashes to forward slashes for SQLAlchemy URL
...
def reset_settings() -> None:
    ...
    This forces settings to be reloaded from environment variables on the next call to get_settings().
    Useful for testing or when environment variables change after initialization.
    """
    global _settings
    _settings = None
